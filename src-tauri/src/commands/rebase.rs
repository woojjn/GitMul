...
use super::models::{RebaseInfo, RebaseResult};
use super::utils::open_repo;

/// Start rebase.
#[tauri::command]
pub fn start_rebase(repo_path: String, onto: String) -> Result<RebaseResult, String> {
